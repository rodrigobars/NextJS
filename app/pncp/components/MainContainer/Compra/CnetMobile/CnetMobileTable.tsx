...
import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Card, CardHeader, CardBody, Divider, Chip } from '@nextui-org/react';
...
export default function CnetMobileTable( { dados } ) {
    ...
    return (
        ...
        //                                                         <p><strong>situacao: </strong>{item.situacao}</p>
